...
class CreatePostPage(BasePage):
    ...
    def verify_successfully_created(self):
        ...
        assert self.get_element_text(self.constants.SUCCESS_MESSAGE_XPATH) == self.constants.SUCCESS_MESSAGE_TEXT, \
            f"Actual: {self.get_element_text(self.constants.SUCCESS_MESSAGE_XPATH)}"
